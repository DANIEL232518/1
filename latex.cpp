    ...
    bool analizarConTablaTransiciones() {
        ...
        while (!estaAlFinal()) {
            ...
            if (nuevoEstado == ERROR_SINTACTICO) {
                ...
                cout << "Valor del token: " << tokenType << "\n\n";
                
                cout << "POSIBLES CAUSAS:\n";
                if (estado == 0) {
                    cout << "  - El documento debe comenzar con: documento_inicio();\n";
                } else if (estado == 1) {
                    cout << "  - Despues de documento_inicio se esperaba: (\n";
                } else if (estado == 2) {
                    cout << "  - Se esperaba un comando valido o documento_fin\n";
                    cout << "  - Comandos validos: titulo, autor, fecha, seccion,\n";
                    cout << "    parrafo, negrita, cursiva, lista_simple, etc.\n";
                } else {
                    cout << "  - Verifica que cada comando termine con ;\n";
                    cout << "  - Verifica los parentesis () de los comandos\n";
                    cout << "  - Verifica las comillas \" en las cadenas\n";
                }
